    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            ...
            default_value=PathJoinSubstitution([
                FindPackageShare('mir_gazebo'), 'urdf', 'mir100_gazebo.urdf.xacro'
            ]),
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource([
                PathJoinSubstitution([FindPackageShare("mir_description"), 'launch', 'mir_launch.py']),
            ]),
        ),
        ...
        Node(
            ...
            parameters=[{
                ...
                # 'qos_overrides./scan.publisher.durability': 'transient_local',
